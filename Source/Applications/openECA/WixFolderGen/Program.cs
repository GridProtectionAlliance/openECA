...
namespace WixFolderGen
{
    class Program
    {
        ...
        const string SolutionRelativeRootFolder = "Applications\\openECA\\openECAClient\\" + RootFolderName;

        // Following paths are relative to build output location
        const string ApplicationPath = "..\\..\\..\\..\\..\\Source\\Applications\\openECA";
        const string SourceFolder = ApplicationPath + "\\openECAClient\\" + RootFolderName;
        const string WebFeaturesDestinationFile = ApplicationPath + "\\openECASetup\\WebFeatures.wxi";
        const string WebFoldersDestinationFile = ApplicationPath + "\\openECASetup\\WebFolders.wxi";
        const string WebFilesDestinationFile = ApplicationPath + "\\openECASetup\\WebFiles.wxi";
