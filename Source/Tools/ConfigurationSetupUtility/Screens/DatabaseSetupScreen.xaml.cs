    ...
    public partial class DatabaseSetupScreen : UserControl, IScreen
    {
        ...
        private void InitializeState()
        {
            if (m_state != null)
            {
                ...
                // *** For the openECA, defaulting to SQLite...
                ...
                if (migrate)
                {
                    ...
                    // Attempt to use the openECA config file first
                    ...
                    {
                        // Attempt to use the openECA Manager config file second
                        ...
                        {
                            // Attempt to use the web based openECA Manager config file as a last resort
        ...
        private void SqliteRadioButton_Checked(object sender, RoutedEventArgs e)
        {
            ...
            // *** For the openECA, not defaulting to sample data enabled...
            //if (!m_sampleScriptChanged && m_sampleDataScriptCheckBox != null)
