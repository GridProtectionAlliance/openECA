...
namespace ConfigurationSetupUtility.Screens
{
    ...
    public partial class SqliteDatabaseSetupScreen : UserControl, IScreen
    {
        ...
        // Constants
        private const string DataProviderString = "AssemblyName={System.Data.SQLite, Version=1.0.108.0, Culture=neutral, PublicKeyToken=db937bc2d44ff139}; ConnectionType=System.Data.SQLite.SQLiteConnection; AdapterType=System.Data.SQLite.SQLiteDataAdapter";
        ...
        private void InitializeState()
        {
            ...
            try
            {
                ...
                // *** For the openECA, we default this to ConfigurationCache folder so that DFS replication can be simple ***
                ...
                //string sqliteDatabaseFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "openECA\\");
                ...
                m_sqliteDatabaseFilePathTextBox.Text = Path.Combine(sqliteDatabaseFilePath, migrate ? App.SqliteConfigv2 : App.BaseSqliteConfig); //"openECA" + App.DatabaseVersionSuffix + ".db" : "openECA.db");
            }
            catch
            {
                m_sqliteDatabaseFilePathTextBox.Text = migrate ? App.SqliteConfigv2 : App.BaseSqliteConfig; //"openECA" + App.DatabaseVersionSuffix + ".db" : "openECA.db";
            }
