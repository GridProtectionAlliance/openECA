namespace Setup
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelInstallationOptions.Text = "This setup utility will install the openECA and/or related tools. This installati" +
    "on requires .NET 4.5 and is only available as a 64-bit installation.";
