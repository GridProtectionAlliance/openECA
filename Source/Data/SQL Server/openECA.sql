--  ----------------------------------------------------------------------------------------------------
--  openECA Data Structures for SQL Server - Gbtc
--
...
--       Script is based on openECA.sql script created by James Ritchie Carroll.
...
USE [master]
GO
CREATE DATABASE [openECA];
GO
ALTER DATABASE [openECA] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [openECA] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [openECA] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [openECA] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [openECA] SET ARITHABORT OFF 
GO
ALTER DATABASE [openECA] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [openECA] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [openECA] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [openECA] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [openECA] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [openECA] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [openECA] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [openECA] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [openECA] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [openECA] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [openECA] SET  ENABLE_BROKER 
GO
ALTER DATABASE [openECA] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [openECA] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [openECA] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [openECA] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [openECA] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [openECA] SET  READ_WRITE 
GO
ALTER DATABASE [openECA] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [openECA] SET  MULTI_USER 
GO
ALTER DATABASE [openECA] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [openECA] SET DB_CHAINING OFF 
GO
-- The next three commented statements are used to create a user with access to the openECA database.
...
--GO
--CREATE ROLE [openECAManagerRole] AUTHORIZATION [dbo]
--GO
--EXEC sp_addrolemember N'openECAManagerRole', N'NewUser'
--GO
--EXEC sp_addrolemember N'db_datareader', N'openECAManagerRole'
--GO
--EXEC sp_addrolemember N'db_datawriter', N'openECAManagerRole'
--GO
...
SELECT    dbo.Node.ID AS NodeID, COALESCE(dbo.Device.NodeID, dbo.Historian.NodeID) AS SourceNodeID, COALESCE(dbo.Historian.Acronym, dbo.Device.Acronym, '__') + ':' + CONVERT(NVARCHAR(10), dbo.Measurement.PointID) AS ID, dbo.Measurement.SignalID, 
                      ...
                      COALESCE(dbo.Device.FramesPerSecond, 30) AS FramesPerSecond, dbo.Protocol.Acronym AS Protocol, dbo.Protocol.Type AS ProtocolType, dbo.SignalType.Acronym AS SignalType, dbo.SignalType.EngineeringUnits,
                      dbo.Phasor.ID AS PhasorID, dbo.Phasor.Label AS PhasorLabel, dbo.Phasor.Type AS PhasorType, dbo.Phasor.Phase, dbo.Phasor.BaseKV,
...
SELECT		NodeID, SourceNodeID, Source + ':' + CONVERT(NVARCHAR(10), PointID) AS ID, SignalID,
                    ...
                    NULL AS DeviceID, FramesPerSecond, ProtocolAcronym AS Protocol, ProtocolType, SignalTypeAcronym AS SignalType, '' AS EngineeringUnits,
                    PhasorID, '' AS PhasorLabel, PhasorType, Phase, 0 AS BaseKV,
                    Adder, Multiplier, CompanyAcronym AS Company, Longitude,
